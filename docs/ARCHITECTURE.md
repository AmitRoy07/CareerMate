...
- AI calls belong in `ai.service.ts` and must go through backend/serverless endpoints.
...
- AI resume analysis must run through Supabase Edge Function or another backend.
