  ...
  return (
    <Screen>
      ...
      <View style={styles.header}>
        ...
        <Text variant="muted">
          {user?.email ?? (demoMode ? "Demo mode" : "No active session")}
        </Text>
      ...
      <Card>
        ...
        <View style={styles.planRow}>
          <View
            style={[styles.linkIcon, { backgroundColor: colors.primarySoft }]}
          >
        ...
        <CreditBadge
          ...
          value={getCreditValue(premium, "ai_resume_scan")}
        />
        <CreditBadge
          label="Job matches"
          value={getCreditValue(premium, "job_match")}
        />
        <CreditBadge
          label="HR mails"
          value={getCreditValue(premium, "hr_mail")}
        />
        <CreditBadge
          label="Mock interviews"
          value={getCreditValue(premium, "mock_interview")}
        />
      </Card>
      ...
      <PremiumFeatureCard
        ...
        icon={FileLock2}
        unlocked={
          premium ? snapshotHasEntitlement(premium, "vault_cloud_sync") : false
        }
      />
      <PremiumFeatureCard
        ...
        unlocked={
          premium
            ? snapshotHasEntitlement(premium, "ai_resume_analyzer")
            : false
        }
      />
      <PremiumFeatureCard
        ...
        unlocked={
          premium
            ? snapshotHasEntitlement(premium, "job_match") ||
              snapshotHasEntitlement(premium, "hr_mail_generator")
            : false
        }
      />
      ...
      <Card>
        ...
        <ProfileLink
          icon={FileText}
          title="Saved resumes"
          subtitle="View and manage your resume drafts"
          onPress={() => router.push("/(tabs)/resume")}
        />
        <ProfileLink
          icon={FileLock2}
          title="Document Vault"
          subtitle="Local-only personal document storage"
          onPress={() => router.push("/vault" as never)}
        />
        <ProfileLink
          icon={ShieldCheck}
          title="Privacy Policy"
          subtitle="How CareerMate handles your data"
          onPress={() => router.push("/legal/privacy")}
        />
        <ProfileLink
          icon={FileText}
          title="Terms & Conditions"
          subtitle="Rules for using CareerMate India"
        ...
        <ProfileLink
          ...
          onPress={() => router.push("/legal/delete-account" as never)}
          danger
        />
      </Card>
      ...
      <Card>
        ...
        <Text variant="muted">
          Manage subscription and Restore Purchases are placeholders until Play
          Store/App Store billing is connected.
        </Text>
        <Button
          ...
          onPress={() =>
            Alert.alert(
              "Coming soon",
              "Payment gateway is intentionally not connected yet.",
            )
          }
        />
        <Button
          ...
          onPress={() =>
            Alert.alert(
              "Coming soon",
              "Store purchase restore will be added with billing integration.",
            )
          }
        />
      </Card>
...
function getCreditValue(
  ...
  creditType: "ai_resume_scan" | "job_match" | "hr_mail" | "mock_interview",
) {
...
function ProfileLink({
  ...
  return (
    <Pressable onPress={onPress} style={styles.linkRow}>
      ...
      <View style={styles.linkCopy}>
        <Text style={danger ? { color: colors.danger } : undefined}>
          {title}
        </Text>
