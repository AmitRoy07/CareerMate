  ...
  return (
    <Screen>
      ...
      <View style={styles.header}>
        <View style={styles.greetingRow}>
          <View style={[styles.avatar, { backgroundColor: colors.navy }]}>
            <Text style={[styles.avatarText, { color: colors.onNavy }]}>
      ...
      <View style={styles.grid}>
        <FeatureCard
          title="Build Resume"
          description="Create your professional ATS-friendly resume for the Indian market."
          icon={FileText}
          primary
        ...
        <FeatureCard
          ...
          description="Calculate your in-hand CTC breakdown including PF and Tax."
          icon={Calculator}
          tone="green"
        ...
        <FeatureCard
          ...
          description="Practice with top company questions and focused revision."
          icon={Brain}
          tone="violet"
        ...
        <FeatureCard
          ...
          description="Store Aadhaar, PAN, certificates, and offers locally with optional cloud backup."
          icon={FileLock2}
          tone="cyan"
      ...
      <View style={styles.grid}>
        <PremiumFeatureCard
          ...
          description="ATS score, missing keywords, and practical fixes."
          icon={Bot}
          onPress={() => router.push("/analyze")}
        />
        <PremiumFeatureCard
          title="Match Resume with Job"
          description="Compare your resume with a job description."
          icon={SearchCheck}
          onPress={() => router.push("/analyze/job-match" as never)}
        />
        <PremiumFeatureCard
          title="Generate HR Email"
          description="Create polished professional HR mails and letters."
          icon={MailPlus}
          onPress={() => router.push("/tools/hr-mail" as never)}
        />
        <PremiumFeatureCard
          title="Premium Templates"
          description="Unlock ATS-friendly layouts and no-watermark exports."
          icon={Crown}
